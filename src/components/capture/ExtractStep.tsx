        ...
        {noKey ? (
          <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 space-y-3">
            ...
            <p className="text-amber-700 text-sm">
              You need an Anthropic API key to extract card details. Add one in Settings first.
            </p>
            <div className="flex gap-3">
              <button onClick={onBack} className="flex-1 py-2.5 border border-gray-300 rounded-lg text-sm font-medium text-gray-700">
                Back
              </button>
              <button
                onClick={() => dispatch({ type: 'SET_VIEW', view: { name: 'settings' } })}
